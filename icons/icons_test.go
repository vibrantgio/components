...
func TestNamesListEachMarkOnce(t *testing.T) {
	...
	want := []icons.Name{icons.Check, icons.Chevron, icons.ChevronPair, icons.Clear, icons.Disclosure, icons.Document, icons.Folder, icons.HistoryBack, icons.HistoryForward, icons.Minus, icons.Plus, icons.Refresh, icons.Search, icons.Sidebar}
	if len(got) != len(want) {
